 ...
 */
public enum Console {
	// 3do(120, "Panasonic 3DO"),  //FIXME 6 Cannot start with a number, but that is folder name :(
    ...
    atari5200(-1, "", "Atari 5200", true, false),
	...
	gb(200, " sur GB", "Nintendo Game Boy", false, true),
    ...
    jaguar(-1, "", "Atari Jaguar", true, false),
	//lutro("Libreto lua games (PAS une console)"),
	lynx(-1, "", "Atari Lynx", true ,false),
	mame(-1, "", "MAME (Arcade)"),
	...
	vectrex(-1, "", "Vectrex"),
	virtualboy(-1, "", "Nintendo Virtual Boy", true, false),
